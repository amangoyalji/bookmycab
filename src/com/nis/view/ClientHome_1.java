...
/**
 * Servlet implementation class ClientHome_1
 */
@WebServlet("/ClientHome_1")
public class ClientHome_1 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	   ...
	   out.println("<html>");
		...
		out.println("<a href=DisplayAgencyBidForClient  target=mw>Current Bookings</a><br>");
