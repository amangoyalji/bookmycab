...
public class AgencyVehicle 
{
	...
	/**
	 * @return the airconditionar
	 */
	public String getAirconditionar() {
		return airconditionar;
	}
	/**
	 * @param airconditionar the airconditionar to set
	 */
	public void setAirconditionar(String airconditionar) {
